...
class AiToolsScreen extends StatelessWidget {
  ...
  static final _studyTools = [
    ...
    _ToolItem(icon: Icons.bar_chart_rounded, color: const Color(0xFF6366F1), label: '시간대별 효율', subtitle: '나의 황금 공부 시간', route: '/ai-tools/efficiency'),
    _ToolItem(icon: Icons.emoji_events_rounded, color: const Color(0xFFEAB308), label: '성취 & 랭킹', subtitle: 'RPG 레벨 & 업적', route: '/rewards'),
  ];
}
